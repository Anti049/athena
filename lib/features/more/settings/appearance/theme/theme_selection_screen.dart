...
import 'package:athena/features/more/settings/appearance/theme/presentation/theme_section.dart';
                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      subtitle: Text(
                        categorizedThemes[category]!.length.toString(),
                      ),
